...
function Message({ message }) {
    ...
    return <div className={`flex items-end space-x-2 relative ${isUserMessage
        ...
        <TimeaAgo
            className={`text-[10px] italic text-gray-400 ${isUserMessage && "order-first pr-1"}`} datetime={message.createdAt}></TimeaAgo>
        <p className={`absolute -bottom-5 text-xs ${isUserMessage ?
            "text-pink-300" : "text-blue-400"}`}>
